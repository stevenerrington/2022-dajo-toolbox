function [bestFitParams,minDiscrepancyFn,dataplotRange,ypred] = util_fitWeibull(xData, yData, weights)
...
[bestFitParams, minDiscrepancyFn, exitflag, output] = util_fminsearchbnd(@(param) Weibull_error(xData, yData, param),param,lower_bounds,upper_bounds,options);
