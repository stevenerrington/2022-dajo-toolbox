    ...
    for alignmentIdx = 1:nEvents
        ...
        for trl = 1:nTrials
            ...
            if isnan(alignmentTimes(trl))
                ...
                idx_1 = util_adjustTDTfs(alignmentTimes(trl), util_getTDTfs('slow')) + alignmentWindow(1);
                idx_2 = util_adjustTDTfs(alignmentTimes(trl), util_getTDTfs('slow')) + alignmentWindow(2)-1;
