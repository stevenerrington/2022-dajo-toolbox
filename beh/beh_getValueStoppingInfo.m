function [valueStopSignalBeh, valueRTdist] = beh_getValueStoppingInfo(stateFlags,Infos,ttx)
...
for rewardIdx = 1:length(rewardLabels)
    ...
    valueRTdist.(rewardLabel).nostop = util_cumulDist(valueRTdist.(rewardLabel).all(ttx.nostop.all.(rewardLabel)));
    valueRTdist.(rewardLabel).noncanc = util_cumulDist(valueRTdist.(rewardLabel).all(ttx.noncanceled.all.(rewardLabel)));
    ...
    [valueStopSignalBeh.inh_weibull.(rewardLabel).parameters,~,...
        ...
        util_fitWeibull(valueStopSignalBeh.inh_SSD.(rewardLabel),...
        valueStopSignalBeh.inh_pnc.(rewardLabel),...
        valueStopSignalBeh.inh_nTr.(rewardLabel));
    
    valueStopSignalBeh.ssrt.(rewardLabel) = beh_getSSRT(valueStopSignalBeh.inh_SSD.(rewardLabel),...
